        ...
        <div class="content">
            <div class="text">
                ...
                <div class="hero-actions">
                    ...
                    <el-button  size="large" style="border-color: white; " color="transparent">记录心情，释放情感</el-button>
                </div>
            </div>
            <div class="robot">
                <el-image :src="iconUrl" alt="robot" class="robot-image" style="width: 150px; height: 150px;" />
            </div>
        </div>
    </div>
</template>
